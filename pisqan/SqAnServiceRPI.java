...
// TODO: build out notdroid usb classes that open serial device using jssc
 ...
 */
public class SqAnServiceRPI { // extends Service implements LocationService.LocationUpdateListener {
...
//    private final IBinder mBinder = new SqAnServiceBinder();
    ...
    private static SqAnServiceRPI thisService = null;
...
//    private NotificationChannel channel = null;
    ...
    public static SqAnServiceRPI getInstance() { return thisService; }
...
//        }
    ...
    private void shutdown() {
        ...
        if (handler != null) {
            ...
            clearServiceAndNotifications();
        SqAnServiceRPI.thisService = null;
    }
    ...
    public void notifyStatusChange(String message) {
        ...
        Intent intentAction = new Intent(this, SqAnServiceRPI.class);
    ...
    public class SqAnServiceBinder extends Binder {
        public SqAnServiceRPI getService() {
            return SqAnServiceRPI.this;
        }
    }
