...
//    public final static String USE_TTY_PATTERN = null;   // null for auto-detect
    public final static String USE_TTY_PATTERN = OSX_TTY_PATTERN;   // set if auto-detect isn't working
