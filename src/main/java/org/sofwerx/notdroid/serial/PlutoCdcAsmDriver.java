package org.sofwerx.notdroid.serial;

import org.sofwerx.notdroid.hardware.usb.*;
import org.sofwerx.notdroid.util.Log;
import org.sofwerx.notdroid.serial.CommonUsbSerialPort;
import org.sofwerx.notdroid.serial.UsbSerialDriver;
import org.sofwerx.notdroid.serial.UsbSerialPort;
...
public class PlutoCdcAsmDriver implements UsbSerialDriver {

    private final String TAG = Config.TAG+".driver";

    private final UsbDevice mDevice;
    private final UsbSerialPort mPort;

    public PlutoCdcAsmDriver(UsbDevice device) {
        mDevice = device;
...
//        private static final int USB_RT_ACM = UsbConstants.USB_TYPE_CLASS | USB_RECIP_INTERFACE;
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        supportedDevices.put(1110, new int[] {46707,});
