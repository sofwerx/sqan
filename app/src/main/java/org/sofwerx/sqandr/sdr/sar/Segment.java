...
public class Segment {
    ...
    public final static int MAX_LENGTH_BEFORE_SEGMENTING = 20; //Not to exceed 250 (Serial line output problem), can't be below 49 (few enough segments to still meet VPN packet size) //TODO tune this number
